...
export const sampleOsintTools: InsertTool[] = [
  ...
  // Add more sample tools for other categories...
  {
    ...
    fullDescription:
      "Shodan is the world's first search engine for Internet-connected devices. It allows cybersecurity professionals and researchers to discover devices exposed to the internet, including webcams, servers, and IoT devices. For OSINT investigators, Shodan provides valuable intelligence about network infrastructure and potential security vulnerabilities.",
